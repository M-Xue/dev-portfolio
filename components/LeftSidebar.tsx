...
export const LeftSidebar = ({sectionRefs}:Props) => {
  ...
  return (
    ...
    >
      <div onClick={(e)=>{e.preventDefault(); sectionRefs.about?.scrollIntoView({ behavior: 'smooth', block: 'start' });}}>
        <IconTooltipWrapper tooltip={"About"} position={"left"}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
        </IconTooltipWrapper>
      </div>
      <div onClick={(e)=>{e.preventDefault(); sectionRefs.workExperience?.scrollIntoView({ behavior: 'smooth', block: 'start' });}}>
        <IconTooltipWrapper tooltip={"Work Experience"} position={"left"}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-git-merge"><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 21V9a9 9 0 0 0 9 9"/></svg>
        </IconTooltipWrapper>
      </div>
      <div onClick={(e)=>{e.preventDefault(); sectionRefs.education?.scrollIntoView({ behavior: 'smooth', block: 'start' });}}>
