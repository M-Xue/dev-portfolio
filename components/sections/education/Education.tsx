      ...
      <div className={styles.content}>
        <div className={styles.intro}>
          ...
          <div className={styles.testContainer}>
            ...
            >
              <div className={styles.expand} ref={nodeRef}></div>
            ...
            <div className={styles.bigBoi}>
              ...
              >
                <div className={styles.text} ref={nodeRefText}>
              ...
              {/* * theres a bug with the hello my name is max animation cuz of the background position of the main page. fix after you clean up this */}

            </div>

          </div>
          <div>testfdfsfasd</div>


                {/* New issue is that we cant get rid of the text div from the flow of the DOM
                  solution: make the contianer and text div -999 z index but make the actual box be 0 z index or whatever the default z index is (maybe use auto)
                */}
...
{/* 
          ...
          {/* 
            put these two in the same div and keep the text one alway on the screen
            use z-index??
