...
const courses = [
  ...
  {
    title: "Databases",
    description: "Learnt the fundamentals of SQL queries and stored procedures with PostgreSQL. Implemented query sanitization to prevent SQL injections. Used normalization to reduce redundancy in ER and relational models.",
...
// Learnt the fundementals of coding (program structures, data types, data structures, programming principles and code style. Created interactive terminal applications with the C programming language. Utilised pointers and manipulated memory at a low level to better understand memory manipulation.
